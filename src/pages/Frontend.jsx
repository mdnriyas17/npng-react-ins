      ...
      <div className="container-fluid service py-5">
        <div className="container py-5">
          ...
          >
            ...
            <p className="mb-0">
              Welcome to NPNG Institute, your premier destination for mastering
              frontend development. Frontend development is the process of
              creating the visible parts of a website or web application
              thatusers interact with directly. It involves using technologies
              such as HTML, CSS, and JavaScript to build user interfaces and
              ensure seamless functionality across various devices and browsers.
              HTML (Hypertext Markup Language) serves as the foundation of web
              development, providing the structure and content of web pages. It
              defines the layout of elements such as text, images, and
              multimedia, enabling developers to create well-organized and
              accessible websites.
            </p>
          </div>
