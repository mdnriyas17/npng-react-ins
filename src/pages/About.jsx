        ...
        <div className="container py-5">
          <div className="row g-5">
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              ...
              <p className="mb-4 about_text text-md">
                ...
                services to meet your unique requirements. From responsive web
                design to seamless e-commerce integration, we have the skills
                and expertise to bring your online vision to life. Let us
                elevate your online presence with cutting-edge technology and
                creative design.
              </p>
            </div>
          </div>
        ...
        <div className="container py-5">
          <div className="row g-5">
            <div className="col-lg-6 wow fadeInRight" data-wow-delay="0.1s">
              ...
              <p className="mb-4">
                At NPNG, we don't just offer courses; we provide an unparalleled
                learning experience that sets the standard for excellence in web
                development education. With a commitment to quality, innovation,
                and student success, NPNG stands as a beacon of excellence in
