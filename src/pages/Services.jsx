        ...
        <nav className="navbar zindex navbar-expand-lg navbar-light bg-transparent px-4 px-lg-5 py-3 py-lg-0 position-fixed top-0">
          ...
          <div className="collapse navbar-collapse" id="navbarCollapse">
            <div className="navbar-nav ms-auto py-0 px-4">
              ...
              <Link to="/services">
                <a className="nav-item nav-link active">Courses</a>
              </Link>
              <Link to="/contectus">
                  ...
                  >
                    <div className="accordion-body my-2">
                      <div>
                        <p>
                          {" "}
                          Welcome to NPNG Institute, your premier destination
                          for mastering frontend development. Frontend
                          development is the process of creating the visible
                          parts of a website or web application thatusers
                          interact with directly. It involves using technologies
                          such as HTML, CSS, and JavaScript to build user
                          interfaces and ensure seamless functionality across
                          various devices and browsers.
                        </p>
                        <p>
                          {" "}
                          HTML (Hypertext Markup Language) serves as the
                          foundation of web development, providing the structure
                          and content of web pages. It defines the layout of
                          elements such as text, images, and multimedia,
                          enabling developers to create well-organized and
                          accessible websites.
                        </p>
                      </div>
                    </div>
                ...
                <div className="accordion-item border-0 mb-4">
                  ...
                  >
                    <div className="accordion-body my-2">
                      <div>
                        <p>
                          Backend development is the foundation of web
                          applications, responsible for handling server-side
                          operations and database management. It involves using
                          technologies such as Java, MySQL, and Spring Boot to
                          build robust and scalable backend systems.
                        </p>
                        <p>
                          Java is a versatile programming language widely used
                          in backend development for its platform independence
                          and strong community support. With Java, developers
                          can create server-side applications, implement
                          business logic, and handle complex computations
                          efficiently.
                        </p>
                      </div>
                    </div>
                ...
                <div className="accordion-item border-0 mb-4">
                  ...
                  >
                    <div className="accordion-body my-2">
                      <div>
                        <p>
                          Web development encompasses a range of skills and
                          technologies essential for creating websites and web
                          applications that deliver exceptional user
                          experiences.
                        </p>
                        <p>
                          Adobe Creative Suite is a suite of software tools used
                          by web developers for graphic design, video editing,
                          and web development. Programs like Photoshop,
                          Illustrator, and XD are invaluable for creating
                          visually stunning designs and prototypes.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="accordion-body my-2">
                      <div>
                        <p>
                          ...
                          frontend and backend components of web applications,
                          covering a wide range of technologies and skills.
                        </p>

                        <p>
                          {" "}
                          HTML, CSS, and JavaScript form the foundation of
                          frontend development, allowing developers to create
                          visually appealing and interactive user interfaces.
                          HTML provides the structure, CSS handles the styling,
                          and JavaScript adds interactivity and functionality to
                          web pages.
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="accordion-body my-2">
                      <div>
                        <p>
                          {" "}
                          Enhance your communication skills with NPNG's
                          Development classNamees. From effective team
                          collaboration to clear client communication, our
                          courses empower web developers to excel in all aspects
                          of professional communication.{" "}
                        </p>
                        <p>
                          Learn to articulate ideas, give impactful
                          presentations, and collaborate seamlessly with develop
                          the communication skills essential for success in the
                          tech industry. colleagues and clients. Our expert-led
                          programs combine theory with practical exercises to
                          ensure you
                        </p>
                      </div>
                    </div>
                ...
                <div className="accordion-item border-0 mb-4">
                  ...
                  >
                    <div className="accordion-body my-2">
                      <div>
                        <p>
                          Elevate your coding prowess with NPNG's Aptitude
                          Development classNamees. Unlock your potential through
                          hands-on learning, problem-solving challenges, and
                          expert guidance. From mastering algorithms to honing
                          critical thinking skills, our comprehensive programs
                          prepare you for success in the ever-evolving tech
                          industry.
                        </p>
                      </div>
                    </div>
